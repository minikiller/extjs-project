 ...
 * @version 1.0.0
 */
Ext.define('kalix.AdminApplication.Dep.controller.DepGridController', {
    ...
    onAdd: function () {
        ...
        var addFormPanel = Ext.create('kalix.AdminApplication.Dep.view.DepAddForm', {
    ...
    onEdit: function (grid, rowIndex, colIndex) {
        ...
        var editFormPanel = Ext.create('kalix.AdminApplication.Dep.view.DepEditForm', {
            url: this.getView().getViewModel().get("url")
        });
