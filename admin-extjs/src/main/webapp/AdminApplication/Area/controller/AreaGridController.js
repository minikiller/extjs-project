 ...
 * @version 1.0.0
 */
Ext.define('kalix.AdminApplication.Area.controller.AreaGridController', {
    ...
    onAdd: function () {
        ...
        var addFormPanel = Ext.create('kalix.AdminApplication.Area.view.AreaAddForm', {
    ...
    onEdit: function (grid, rowIndex, colIndex) {
        ...
        var editFormPanel = Ext.create('kalix.AdminApplication.Area.view.AreaEditForm', {
            url: this.getView().getViewModel().get("url")
        });
