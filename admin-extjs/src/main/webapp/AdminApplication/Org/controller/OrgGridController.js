 ...
 * @version 1.0.0
 */
Ext.define('kalix.AdminApplication.Org.controller.OrgGridController', {
    ...
    onAdd: function () {
        ...
        var addFormPanel = Ext.create('kalix.AdminApplication.Org.view.OrgAddForm', {
    ...
    onEdit: function (grid, rowIndex, colIndex) {
        ...
        var editFormPanel = Ext.create('kalix.AdminApplication.Org.view.OrgEditForm', {
            url: this.getView().getViewModel().get("url")
        });
        var OrgModel = Ext.create("kalix.AdminApplication.Org.model.OrgModel", {
            id: rec.data.id,
            name: rec.data.name,
            code: rec.data.code,
