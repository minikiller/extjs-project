 ...
 * @version 1.0.0
 */
Ext.define('kalix.admin.app.application.controller.ApplicationGridController', {
    ...
    onAdd: function () {
        ...
        var addFormPanel = Ext.create('kalix.admin.app.application.view.ApplicationAddForm', {
    ...
    onEdit: function (grid, rowIndex, colIndex) {
        ...
        var editFormPanel = Ext.create('kalix.admin.app.application.view.ApplicationEditForm', {
            url: this.getView().getViewModel().get("url")
        });
