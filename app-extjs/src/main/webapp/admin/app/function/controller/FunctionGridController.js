 ...
 * @version 1.0.0
 */
Ext.define('kalix.admin.app.function.controller.FunctionGridController', {
    ...
    onAdd: function () {
        ...
        var addFormPanel = Ext.create('kalix.admin.app.function.view.FunctionAddForm', {
    ...
    onEdit: function (grid, rowIndex, colIndex) {
        ...
        var editFormPanel = Ext.create('kalix.admin.app.function.view.FunctionEditForm', {
            url: this.getView().getViewModel().get("url")
        });
