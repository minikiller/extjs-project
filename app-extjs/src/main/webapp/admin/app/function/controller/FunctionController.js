 ...
 * @version 1.0.0
 */
Ext.define('kalix.admin.app.function.controller.FunctionController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.functionController',
    requires: [
        "kalix.admin.app.application.view.ApplicationTreeList",
        'kalix.admin.app.function.view.FunctionGrid'
    ],
    /**
     * 初始化面板.
    ...
    onInitApplicationList: function () {
        var applicationListPanel = Ext.create("kalix.admin.app.application.view.ApplicationTreeList", {
            store: Ext.create("kalix.admin.app.application.store.ApplicationTreeListStore"),
            region: "west",
    ...
    onInitDataGrid: function () {
        var dataGird = Ext.create("kalix.admin.app.function.view.FunctionGrid", {
            store: Ext.create("kalix.admin.app.function.store.FunctionStore")
        });
        return dataGird;
    }
});