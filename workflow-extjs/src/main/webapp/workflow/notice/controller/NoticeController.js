 ...
 * @version 1.0.0
 */
Ext.define('kalix.workflow.notice.controller.NoticeController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.noticeController',
    requires: [
        'kalix.view.components.common.PagingToolBar',
        'kalix.workflow.notice.view.NoticeGrid',
        'kalix.workflow.notice.store.NoticeStore'
    ],
    /**
     * 初始化面板.
    ...
    onInitDataGrid: function () {
        var noticeStore = Ext.create('kalix.workflow.notice.store.NoticeStore');
        var dataGird = Ext.create("kalix.workflow.notice.view.NoticeGrid",
            {
                store: noticeStore,
                bbar: [{
