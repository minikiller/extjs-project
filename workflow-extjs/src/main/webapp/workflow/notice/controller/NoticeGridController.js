 ...
 * @version 1.0.0
 */
Ext.define('kalix.workflow.notice.controller.NoticeGridController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.noticeGridController',

    onPersonSelect: function (grid, record, index, eOpts) {
        //this.setCurrentNotice(notice);
        console.log(record);
    },
    /**
     * 打开新增操作.
     ...
     */
    onAdd: function () {
        var addFormPanel = Ext.create('kalix.workflow.notice.view.NoticeAddForm', {
    ...
    onEdit: function (grid, rowIndex, colIndex) {
        ...
        /*var rec = grid.getStore().getAt(rowIndex);
         var editFormPanel = Ext.create('kalix.workflow.notice.view.NoticeEditForm', {
         url: this.getView().getViewModel().get("url")
         });
         var noticeModel = Ext.create("kalix.workflow.notice.model.NoticeModel", {
         id: rec.data.id,
