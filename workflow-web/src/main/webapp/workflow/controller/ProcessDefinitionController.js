 ...
 * @version 1.0.0
 */
Ext.define('Kalix.workflow.controller.ProcessDefinitionController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.processDefinitionController',
    requires: [
        'Kalix.view.components.common.PagingToolBar',
        'Kalix.workflow.view.ProcessDefinitionGrid',
    ...
    onInitDataGrid: function () {
        var processDefinitionStore = Ext.create('Kalix.workflow.store.ProcessDefinitionStore');
        var dataGird = Ext.create("Kalix.workflow.view.ProcessDefinitionGrid",
            {
