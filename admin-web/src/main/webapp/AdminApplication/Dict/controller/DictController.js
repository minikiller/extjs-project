 ...
 * @version 1.0.0
 */
Ext.define('kalix.AdminApplication.Dict.controller.DictController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.dictController',
    requires: [
        'kalix.view.components.common.PagingToolBar',
        'kalix.AdminApplication.Dict.view.DictGrid'
    ],
    /**
     * 初始化面板.
    ...
    onInitDataGrid: function () {
        var dataStore = Ext.create("kalix.AdminApplication.Dict.store.DictStore");
        var dataGird = Ext.create("kalix.AdminApplication.Dict.view.DictGrid", {
            store: dataStore,
