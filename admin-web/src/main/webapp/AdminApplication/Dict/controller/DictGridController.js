 ...
 * @version 1.0.0
 */
Ext.define('kalix.AdminApplication.Dict.controller.DictGridController', {
     ...
     */
    onAdd: function () {
        var addFormPanel = Ext.create('kalix.AdminApplication.Dict.view.DictAddForm', {
    ...
    onEdit: function (grid, rowIndex, colIndex) {
        ...
        var editFormPanel = Ext.create('kalix.AdminApplication.Dict.view.DictEditForm', {
            url: this.getView().getViewModel().get("url")
        });
        var dictModel = Ext.create("kalix.AdminApplication.Dict.model.DictModel", {
            id: rec.data.id,
