 ...
 * @version 1.0.0
 */
Ext.define('kalix.AdminApplication.Role.controller.RoleGridController', {
     ...
     */
    onAdd: function () {
        var addFormPanel = Ext.create('kalix.AdminApplication.Role.view.RoleAddForm', {
    ...
    onEdit: function (grid, rowIndex, colIndex) {
        ...
        var editFormPanel = Ext.create('kalix.AdminApplication.Role.view.RoleEditForm', {
            url: this.getView().getViewModel().get("url")
        });
