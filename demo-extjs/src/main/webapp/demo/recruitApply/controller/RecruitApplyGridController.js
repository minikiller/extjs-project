 ...
 * @author chenyanxu
 */
Ext.define('kalix.demo.recruitApply.controller.RecruitApplyGridController', {
    ...
    onWorkFlowStart: function (grid, rowIndex, colIndex) {
        ...
        postUrl = CONFIG.restRoot + '/camel/rest/recruitapplys/workflow/startProcess?id=' + rec.data.id;
        Ext.Ajax.request({
            url: postUrl,
            method: 'GET',
