...
Ext.define('kalix.demo.meetingApply.model.MeetingApplyModel', {
    ...
    fields: [
        ...
        {name: 'host'},//主持人
        {name: 'meetingDate', type: 'date', dateFormat: 'Y-m-d W', defaultValue: new Date()},//会议申请时间
        {name: 'weekOfDate'}, //星期几
        {name: 'beginTime', type: 'date', dateFormat: 'H:i:s'}, //会议时段,开始时间
        {name: 'endTime', type: 'date', dateFormat: 'H:i:s'}, //会议时段，结束时间
